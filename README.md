![](https://git.halogenos.org/halogenOS/android_manifest/-/raw/XOS-16.2/halogenos-baklava-v2.svg)
...
```bash
repo init -u https://git.halogenos.org/halogenOS/android_manifest.git -b XOS-16.2
```
